...
//	t.id = id;
//	t.ram = ram;
//	t.producator = (char*)malloc(sizeof(char) * strlen(producator) + 1); //sizeofchar =1 deci pt simplificare nu il mai adaug
//	strcpy_s(t.producator, strlen(producator) + 1, producator);
//	t.pret = pret;
//	t.serie = serie;
//
...
//	{
//		printf("Producatorul %s are seria %s si idul %d", t.producator, t.serie, t.id);
//			
//	}
//
//	else {
//		printf("Producatorul este null\n");
//	}
//
//}
//
...
//}
//
//struct Telefon* copiaza1stElements(struct Telefon* vector, int nrElemente, int nrElementeCopiate) {
//	struct Telefon* vectorNou = NULL;
//	vectorNou = (struct Telefon*)malloc(sizeof(struct Telefon) * nrElemente);
//	//vectorNou
//	
//		for (int i = 0;i < nrElemente;i++) {
//			vectorNou[i] = vector[i];
//			vectorNou[i].producator = (char*)malloc(strlen(vector[i].producator) + 1);
//			strcpy_s(vectorNou[i].producator, sizeof(vector[i].producator) + 1), vector[i].producator));
//	}
//
//		return vectorNou;
//}
...
//
//
//	void dezaloc2A(struct Telefon**t, int *nrElemente)
//	
//	{
//		for (int i=0;i<nrElemente;i++) {
...
//	}
//	
//	void dezaloc2B(struct Telefon** t, int* nrElemente)
//
//	{
//		for (int i=0;i<nrElemente;i++)
//		{
...
//
//
//	struct Telefon** copiazaTelefoaneScumpe()
//
//
...
//
//
//	void copybyCondition(struct*Telefon vector, struct Telefon** vectorNou, )
//
